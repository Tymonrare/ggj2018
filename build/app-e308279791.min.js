		...
		_createClass(_class, [{
			...
			value: function sendGhost() {
				...
				setTimeout(function () {
					...
					console.log(_this2.targetBoiler);
			...
			value: function handleGhosts(event) {
				if (!this.tranferin && gm.activeGhost && this.allowTeleport && this.crystal.getBounds().contains(event.data.global.x, event.data.global.y)) {
					...
					gm.activeGhost = null;
				} else if (this.containsGhost && !tranfering) {
