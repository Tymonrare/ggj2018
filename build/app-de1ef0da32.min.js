	...
	return function (_TableItem) {
		...
		_createClass(_class, [{
			...
			value: function sendGhost() {
				...
				createjs.Tween.get(this.highlightRopesRay.scale, { loop: false }).to({ x: 7, y: 2 }, 200, createjs.Ease.quadOut).wait(1500).to({ x: 5, y: 1 }, 500, createjs.Ease.linear); //just return for next animation
