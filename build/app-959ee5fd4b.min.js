	...
	return function (_TableItem) {
		...
		_createClass(_class, [{
			...
			value: function sendGhost() {
				...
				createjs.Tween.get(this.highlightRopesRay.scale, { loop: false }).to({ x: 7, y: 2 }, 100, createjs.Ease.quadOut).to({ x: 5, y: 1 }, 1000, createjs.Ease.quartIn); //just return for next animation
