...
function randElem(array) {
  if (array && array.length && Array.isArray(array)) return array[randi(array.length - 1)];else return null;
}
...
(function () {
	...
	function load() {
		...
		loader.add('fnt', 'res/fonts/digital-regular/digital-regular.fnt').add('png', 'res/fonts/digital-regular/digital-regular.png');
		loader.load(function (loader, resources) {
			PIXI.loaders.parseBitmapFontData(resources.fnt, resources.png);
		});
	}
...
var TableItem = function () {
	...
	return function (_PIXI$projection$Spri) {
		_inherits(_class, _PIXI$projection$Spri);

		function _class(texture, props) {
			_classCallCheck(this, _class);

			//set props
			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(_class).call(this, texture));
			...
			_this.anchor.set(0.5, props.stands ? 1.0 : 0.5);
