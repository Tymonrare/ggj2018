	...
	return function (_TableItem) {
		...
		_createClass(_class, [{
			...
			value: function sendGhost() {
				...
				createjs.Tween.get(this.highlightRopesRay, { loop: false }).to({ alpha: 1 }, 50, createjs.Ease.quartInOut).to({ alpha: 0.7 }, 500, createjs.Ease.quartInOut); //just return for next animation
