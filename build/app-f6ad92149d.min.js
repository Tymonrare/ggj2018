	...
	function initTableStuff() {
		...
		}
		{
			for (var i = 0; i < 10; i++) {
				...
				item.position.set(-gm.app.screen.width * Math.random() * 2, -gm.app.screen.height * Math.random());
		...
		for (var i in items) {
			...
			//item.position.set(randiRange(-gm.app.screen.width/2, gm.app.screen.width/2), randiRange(-gm.app.screen.height/2, gm.app.screen.height/2));
			item.position.set(randfRange(-gm.app.screen.width / 2, gm.app.screen.width / 2), randiRange(-gm.app.screen.height / 2, gm.app.screen.height / 2));
			item.snap();
